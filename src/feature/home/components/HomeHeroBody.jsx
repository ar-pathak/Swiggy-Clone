    ...
    return (
        <div className='w-full pt-16 pb-8 '>
            ...
            <div className="flex w-full pt-6 gap-4 justify-center px-4 z-10">
                {/* Location input */}
                <div className="flex items-center gap-3 w-[302px] h-[60px] px-3 bg-white rounded-lg border border-gray-200 shadow-sm 
                ...
                {/* Restaurant search */}
                <div className=" w-[408px] h-[60px] bg-white rounded-lg border border-gray-200 shadow-sm 
                  focus-within:border-amber-500 focus-within:ring-2 focus-within:ring-amber-100 transition">
